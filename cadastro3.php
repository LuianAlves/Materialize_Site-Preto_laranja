				...
				<form action="mail.php" method="post">
					...
					<div class="input-field">
    					<select type="text" name="plano" id="plano">
      						<optgroup label="Planos Filmes">
      							<option value="" disabled selected>Escolha seu Plano</option>
        						<option value="1">8MBS R$69,99</option>
        						<option value="2">10MBS R$79,99</option>
        						<option value="3">15MBS R$99,99</option>
        						<option value="4">20MBS R$119,99</option>
        						<option value="5">25MBS R$139,99</option>
      						</optgroup>	
    					</select>
  					</div>
